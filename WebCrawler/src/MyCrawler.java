...
public class MyCrawler extends WebCrawler {
	...
	public static List reviewList= new ArrayList<Review>();
	public static Set reviews= new HashSet<String>();
        ...
        public boolean shouldVisit(WebURL url) {
                ...
                return !FILTERS.matcher(href).matches() && href.startsWith("http://www.tasty.lk/wadduw")&& !href.startsWith("http://www.tasty.lk/wadduw/restaurants")&&href.indexOf('?')==-1&&!href.contains("www.facebook.com")&&!href.contains("review");
        }
               ...
               // System.out.println(url);
                if (page.getParseData() instanceof HtmlParseData) {
                        ...
                        for (Element element : eles2) {
                            ...
                            reviewList.add(new Review(revi,rev));
